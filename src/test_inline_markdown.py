...
class TestInlineMarkdown(unittest.TestCase):
    def test_delim_bold(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode("bolded", TextType.TEXT_BOLD),
    ...
    def test_delim_italic(self):
        node = TextNode("This is text with an _italic_ word", TextType.TEXT_PLAIN)
    ...
    def test_split_links(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode(" and ", TextType.TEXT_PLAIN),
                TextNode("another link", TextType.TEXT_LINK, "https://blog.boot.dev"),
                TextNode(" with text that follows", TextType.TEXT_PLAIN),
            ],
            new_nodes,
        )
